...
function preload(){
    ...
    boyAnime = loadAnimation("walking_1.png","walking_2.png","walking_3.png","walking_4.png","walking_5.png",
    "walking_6.png","walking_7.png","walking_8.png");
    nightAnime = loadImage("night.jpg")
}

function setup(){
    night = createSprite(width/2, height/2, 50, 50)
    night.addImage(nightAnime);
    night.velocityX = -4;
    boy = createSprite(650, 550, 20, 20);
    boy.addAnimation("walkinf", boyAnime);
    boy.scale = 0.5;
